...
class CategoryController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = DigitalCategory::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('DigitalCategory', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Digital Categories');
