...
class DigitalCategory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('cat_title, cat_desc, creation_date, creation_id, modified_id', 'required'),
			...
			array('cat_id, publish, cat_title, cat_desc, creation_date, creation_id, modified_date, modified_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'ommuDigitals_relation' => array(self::HAS_MANY, 'OmmuDigitals', 'cat_id'),
		);
	}
