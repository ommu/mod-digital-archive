...
<fieldset>
	...
	<div class="clearfix publish">
		<?php echo $form->labelEx($model,'cover_resize'); ?>
		<div class="desc">
			<?php echo $form->checkBox($model,'cover_resize'); ?>
			<?php echo $form->labelEx($model,'cover_resize'); ?>
			<?php echo $form->error($model,'cover_resize'); ?>
			<?php /*<div class="small-px silent"></div>*/?>
		</div>
	</div>

	<div class="clearfix">
		<?php echo $form->labelEx($model,'cover_resize_size'); ?>
		<div class="desc">
	...
	<div class="clearfix">
		<?php echo $form->labelEx($model,'cover_view_size'); ?>
		<div class="desc">
			<?php echo $form->textArea($model,'cover_view_size',array('rows'=>6, 'cols'=>50)); ?>
			<?php echo $form->error($model,'cover_view_size'); ?>
			<?php /*<div class="small-px silent"></div>*/?>
		</div>
	</div>
