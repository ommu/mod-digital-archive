 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_digital_author".
 *
 * The followings are the available columns in table 'ommu_digital_author':
...
class DigitalAuthor extends CActiveRecord
{
	 ...
	 * @return DigitalAuthor the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'ommuDigitalAuthors_relation' => array(self::HAS_MANY, 'OmmuDigitalAuthors', 'author_id'),
		);
	}
	...
	public function search()
	{
		...
		if(!isset($_GET['DigitalAuthor_sort']))
