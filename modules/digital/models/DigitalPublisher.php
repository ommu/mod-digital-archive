 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_digital_publisher".
 *
 * The followings are the available columns in table 'ommu_digital_publisher':
 ...
 */
class DigitalPublisher extends CActiveRecord
{
	 ...
	 * @return DigitalPublisher the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('publish, publisher_name, publisher_location, publisher_address, creation_date, creation_id, modified_id', 'required'),
			array('publish', 'numerical', 'integerOnly'=>true),
			array('creation_id, modified_id', 'length', 'max'=>11),
			array('modified_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('publisher_id, publish, publisher_name, publisher_location, publisher_address, creation_date, creation_id, modified_date, modified_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'ommuDigitals_relation' => array(self::HAS_MANY, 'OmmuDigitals', 'publisher_id'),
		);
	}
	...
	public function search()
	{
		...
		if(!isset($_GET['DigitalPublisher_sort']))
