...
<?php $this->widget('application.components.system.FDetailView', array(
	...
	'attributes'=>array(
		array(
			...
			//'value'=>$model->cover_id != '' ? $model->cover_id : '-',
		),
		array(
			'name'=>'publish',
		...
		array(
			...
			//'value'=>$model->cover_filename != '' ? CHtml::link($model->cover_filename, Yii::app()->request->baseUrl.'/public/visit/'.$model->cover_filename, array('target' => '_blank')) : '-',
			'type'=>'raw',
		),
		array(
			'name'=>'creation_date',
