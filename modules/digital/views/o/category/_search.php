...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<ul>
		...
		<li>
			<?php echo $model->getAttributeLabel('cat_title'); ?><br/>
			<?php echo $form->textField($model,'cat_title',array('size'=>32,'maxlength'=>32)); ?>
		</li>

		<li>
			<?php echo $model->getAttributeLabel('cat_desc'); ?><br/>
