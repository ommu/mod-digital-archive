<?php
/**
 * Digital Download Details (digital-download-detail)
 ...
 */
	...
	$this->breadcrumbs=array(
		'Digital Download Details'=>array('manage'),
		'Manage',
	);
	$this->menu=array(
		array(
...
<div id="partial-digital-download-detail">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
		...
		<?php 
			...
			*/
			...
			$this->widget('application.components.system.OGridView', array(
				'id'=>'digital-download-detail-grid',
