...
<fieldset>
	...
	<div class="clearfix">
		<?php echo $form->labelEx($model,'like_id'); ?>
		<div class="desc">
			<?php echo $form->textField($model,'like_id',array('size'=>11,'maxlength'=>11)); ?>
			<?php echo $form->error($model,'like_id'); ?>
			<?php /*<div class="small-px silent"></div>*/?>
		</div>
	</div>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php
			$model->likes_date = !$model->isNewRecord ? (!in_array($model->likes_date, array('0000-00-00','1970-01-01')) ? date('d-m-Y', strtotime($model->likes_date)) : '') : '';
			//echo $form->textField($model,'likes_date');
