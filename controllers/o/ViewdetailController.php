...
class ViewdetailController extends Controller
{
	...
	public function actionManage() 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'Digital View Details Manage');
	...
	{
		$model = DigitalViewDetail::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='digital-view-detail-form') {
