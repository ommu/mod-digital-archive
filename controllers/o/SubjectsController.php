...
class SubjectsController extends Controller
{
	...
	{
		$model=new DigitalSubjects;

		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['digital_id'], $_POST['tag_id'], $_POST['subject'])) {
	...
	public function actionDelete($id) 
	{
			...
			if($model->delete()) {
				if(Yii::app()->getRequest()->getParam('type') == 'digital') {
					...
					echo CJSON::encode(array(
						...
						'id' => 'partial-digital-subjects',
						'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'DigitalSubjects success deleted.').'</strong></div>',
					));
				}
			}
			Yii::app()->end();
		...
		$this->pageTitle = Yii::t('phrase', 'DigitalSubjects Delete.');
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	{
		$model = DigitalSubjects::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='digital-subjects-form') {
