 ...
 * @var $model DigitalDownloadDetail
...
class DownloaddetailController extends Controller
{
	...
	public function actionManage() 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'Digital Download Details Manage');
	...
	{
		$model = DigitalDownloadDetail::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='digital-download-detail-form') {
