...
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes'=>array(
		...
		array(
			...
			'value'=>!in_array($model->print_request_date, array('0000-00-00','1970-01-01','0002-12-02','-0001-11-30')) ? $this->dateFormat($model->print_request_date) : '-',
		),
		array(
			'name'=>'print_date',
			'value'=>!in_array($model->print_date, array('0000-00-00','1970-01-01','0002-12-02','-0001-11-30')) ? $this->dateFormat($model->print_date) : '-',
		),
		array(
			'name'=>'creation_date',
