 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_digital_subjects".
 *
 * The followings are the available columns in table 'ommu_digital_subjects':
 * @property string $id
...
class DigitalSubjects extends CActiveRecord
{
	 ...
	 * @return DigitalSubjects the static model class
	 */
