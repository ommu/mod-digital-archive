 ...
 * @created date 3 November 2016, 16:07 WIB
 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_digital_subject".
 *
 * The followings are the available columns in table '_view_digital_subject':
 * @property string $tag_id
 * @property string $digitals
 * @property string $digital_all
 */
class ViewDigitalSubject extends CActiveRecord
{
	use UtilityTrait;
	 ...
	 * @return ViewDigitalSubject the static model class
	 */
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('ViewDigitalSubject_sort'))
