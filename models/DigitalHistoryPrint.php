...
class DigitalHistoryPrint extends CActiveRecord
{
	...
	public function search()
	{
		...
		if($this->print_request_date != null && !in_array($this->print_request_date, array('0000-00-00 00:00:00','1970-01-01 00:00:00','0002-12-02 07:07:12','-0001-11-30 00:00:00')))
			$criteria->compare('date(t.print_request_date)', date('Y-m-d', strtotime($this->print_request_date)));
		if($this->print_date != null && !in_array($this->print_date, array('0000-00-00 00:00:00','1970-01-01 00:00:00','0002-12-02 07:07:12','-0001-11-30 00:00:00')))
		...
		if(!Yii::app()->getRequest()->getParam('DigitalHistoryPrint_sort'))
	...
	protected function afterConstruct() {
		if(count($this->defaultColumns) == 0) {
			...
			$this->defaultColumns[] = array(
				...
				'filter' => $this->filterDatepicker($this, 'print_request_date'),
			);
			$this->defaultColumns[] = array(
				'name' => 'print_date',
				...
				'filter' => $this->filterDatepicker($this, 'print_date'),
			);
			$this->defaultColumns[] = array(
